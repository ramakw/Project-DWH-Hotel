...
CREATE TABLE `harga_menu` (
  `id_harga_menu` bigint(20) NOT NULL AUTO_INCREMENT,
  `id_menu` bigint(20) NOT NULL,
  ...
  KEY `idx_harga_menu_id_menu` (`id_menu`),
  KEY `idx_harga_menu_periode` (`id_menu`,`berlaku_dari`,`berlaku_sampai`),
  CONSTRAINT `harga_menu_ibfk_1` FOREIGN KEY (`id_menu`) REFERENCES `menu` (`id_menu`) ON UPDATE CASCADE
